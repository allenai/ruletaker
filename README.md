...
**Output option 1.** A CSV file containing the generated theories and assertions in English.
...
**Output option 2.** A CSV file containing the generated theories and assertions as a logic program in the format expected by the theorem prover used, along with a truth label.
